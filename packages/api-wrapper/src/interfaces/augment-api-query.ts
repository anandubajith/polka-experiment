...
import type { BTreeMap, BTreeSet, Bytes, Option, U8aFixed, Vec, WrapperKeepOpaque, WrapperOpaque, bool, u128, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetHandler: {
       ...
       * Allowlisted tokens
       **/
      allowlistedToken: AugmentedQuery<ApiType, () => Observable<BTreeSet<H160>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * AssetId Precision
       **/
      assetPrecision: AugmentedQuery<ApiType, (arg: U8aFixed | string | Uint8Array) => Observable<AssetHandlerPrecisionType>, [U8aFixed]> & QueryableStorageEntry<ApiType, [U8aFixed]>;
      /**
       * Block Difference required for Withdrawal Execution
       **/
      bridgeDeactivated: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       * Pending Withdrawals
       **/
      pendingWithdrawals: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<AssetHandlerPendingWithdrawal>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Block Difference required for Withdrawal Execution
       **/
      withdrawalExecutionBlockDiff: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    chainBridge: {
      assetIdToResourceMap: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<U8aFixed>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      bridgeEvents: AugmentedQuery<ApiType, () => Observable<Vec<ChainbridgeBridgeEvent>>, []> & QueryableStorageEntry<ApiType, []>;
      ...
      votes: AugmentedQuery<ApiType, (arg1: u8 | AnyNumber | Uint8Array, arg2: ITuple<[u64, Call]> | [u64 | AnyNumber | Uint8Array, Call | IMethod | string | Uint8Array]) => Observable<Option<ChainbridgeProposalVotes>>, [u8, ITuple<[u64, Call]>]> & QueryableStorageEntry<ApiType, [u8, ITuple<[u64, Call]>]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    ocex: {
      accounts: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PolkadexPrimitivesOcexAccountInfo>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      allowlistedEnclaves: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<bool>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Allowlisted tokens
       **/
      allowlistedToken: AugmentedQuery<ApiType, () => Observable<BTreeSet<PolkadexPrimitivesAssetsAssetId>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * CertificateValidity
       **/
      certificateValidity: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      exchangeState: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      feesCollected: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<PolkadexPrimitivesSnapshotFees>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      ingressMessages: AugmentedQuery<ApiType, () => Observable<Vec<PolkadexPrimitivesIngressIngressMessages>>, []> & QueryableStorageEntry<ApiType, []>;
      onChainEvents: AugmentedQuery<ApiType, () => Observable<Vec<PolkadexPrimitivesOcexOnChainEvents>>, []> & QueryableStorageEntry<ApiType, []>;
      registeredEnclaves: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<u64>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      snapshotNonce: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> & QueryableStorageEntry<ApiType, []>;
      snapshots: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadexPrimitivesSnapshotEnclaveSnapshot>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      totalAssets: AugmentedQuery<ApiType, (arg: PolkadexPrimitivesAssetsAssetId | { asset: any } | { polkadex: any } | string | Uint8Array) => Observable<RustDecimalDecimal>, [PolkadexPrimitivesAssetsAssetId]> & QueryableStorageEntry<ApiType, [PolkadexPrimitivesAssetsAssetId]>;
      tradingPairs: AugmentedQuery<ApiType, (arg1: PolkadexPrimitivesAssetsAssetId | { asset: any } | { polkadex: any } | string | Uint8Array, arg2: PolkadexPrimitivesAssetsAssetId | { asset: any } | { polkadex: any } | string | Uint8Array) => Observable<Option<PolkadexPrimitivesOcexTradingPairConfig>>, [PolkadexPrimitivesAssetsAssetId, PolkadexPrimitivesAssetsAssetId]> & QueryableStorageEntry<ApiType, [PolkadexPrimitivesAssetsAssetId, PolkadexPrimitivesAssetsAssetId]>;
      withdrawals: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<BTreeMap<AccountId32, Vec<PolkadexPrimitivesWithdrawal>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    pdexMigration: {
       ...
       **/
      ethTxns: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<PdexMigrationBurnTxDetails>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Locked Token holders
       **/
      lockedTokenHolders: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<u32>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Maximum Mintable tokens
       **/
      mintableTokens: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Flag that enables the migration
       **/
      operational: AugmentedQuery<ApiType, () => Observable<bool>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * List of relayers who can relay data from Ethereum
       **/
      relayers: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<bool>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<NodePolkadexRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, NodePolkadexRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
