...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetHandler: {
       ...
       **/
      AllowlistedTokenAdded: AugmentedEvent<ApiType, [H160]>;
      /**
       * This token got removed from Allowlisted Tokens
       **/
      AllowlistedTokenRemoved: AugmentedEvent<ApiType, [H160]>;
      /**
       * Asset Deposited (Recipient, ResourceId, Amount)
       **/
      AssetDeposited: AugmentedEvent<ApiType, [AccountId32, U8aFixed, u128]>;
      /**
       * Asset Registered
       **/
      AssetRegistered: AugmentedEvent<ApiType, [U8aFixed]>;
      /**
       * Asset Withdrawn (Recipient, ResourceId, Amount)
       **/
      AssetWithdrawn: AugmentedEvent<ApiType, [H160, U8aFixed, u128]>;
      /**
       * BlocksDelayUpdated
       **/
      BlocksDelayUpdated: AugmentedEvent<ApiType, [u32]>;
      /**
       * NewBridgeStatus
       **/
      BridgeStatusUpdated: AugmentedEvent<ApiType, [bool]>;
      FeeUpdated: AugmentedEvent<ApiType, [u8, u128]>;
      /**
       * FungibleTransferFailed
       **/
      FungibleTransferFailed: AugmentedEvent<ApiType, [U8aFixed]>;
      /**
       * Generic event
       **/
    ...
    chainBridge: {
       ...
       **/
      ChainAllowlisted: AugmentedEvent<ApiType, [u8]>;
      /**
       ...
       * TransactionFound
       **/
      TransactionFound: AugmentedEvent<ApiType, []>;
      /**
    ...
    ocex: {
       ...
       **/
      AllowlistedTokenRemoved: AugmentedEvent<ApiType, [PolkadexPrimitivesAssetsAssetId]>;
      DepositSuccessful: AugmentedEvent<ApiType, [user: AccountId32, asset: PolkadexPrimitivesAssetsAssetId, amount: u128], { user: AccountId32, asset: PolkadexPrimitivesAssetsAssetId, amount: u128 }>;
      EnclaveAllowlisted: AugmentedEvent<ApiType, [AccountId32]>;
      EnclaveCleanup: AugmentedEvent<ApiType, [Vec<AccountId32>]>;
      EnclaveRegistered: AugmentedEvent<ApiType, [AccountId32]>;
      /**
       * Exchange state has been updated
       **/
      ExchangeStateUpdated: AugmentedEvent<ApiType, [bool]>;
      FeesClaims: AugmentedEvent<ApiType, [beneficiary: AccountId32, snapshotId: u32], { beneficiary: AccountId32, snapshotId: u32 }>;
      MainAccountRegistered: AugmentedEvent<ApiType, [main: AccountId32, proxy: AccountId32], { main: AccountId32, proxy: AccountId32 }>;
      NewProxyAdded: AugmentedEvent<ApiType, [main: AccountId32, proxy: AccountId32], { main: AccountId32, proxy: AccountId32 }>;
      OpenTradingPair: AugmentedEvent<ApiType, [pair: PolkadexPrimitivesOcexTradingPairConfig], { pair: PolkadexPrimitivesOcexTradingPairConfig }>;
      ProxyRemoved: AugmentedEvent<ApiType, [main: AccountId32, proxy: AccountId32], { main: AccountId32, proxy: AccountId32 }>;
      ShutdownTradingPair: AugmentedEvent<ApiType, [pair: PolkadexPrimitivesOcexTradingPairConfig], { pair: PolkadexPrimitivesOcexTradingPairConfig }>;
      /**
       * TokenAllowlisted
       **/
      TokenAllowlisted: AugmentedEvent<ApiType, [PolkadexPrimitivesAssetsAssetId]>;
      TradingPairIsNotOperational: AugmentedEvent<ApiType, []>;
      TradingPairRegistered: AugmentedEvent<ApiType, [base: PolkadexPrimitivesAssetsAssetId, quote: PolkadexPrimitivesAssetsAssetId], { base: PolkadexPrimitivesAssetsAssetId, quote: PolkadexPrimitivesAssetsAssetId }>;
      TradingPairUpdated: AugmentedEvent<ApiType, [base: PolkadexPrimitivesAssetsAssetId, quote: PolkadexPrimitivesAssetsAssetId], { base: PolkadexPrimitivesAssetsAssetId, quote: PolkadexPrimitivesAssetsAssetId }>;
      WithdrawalClaimed: AugmentedEvent<ApiType, [main: AccountId32, withdrawals: Vec<PolkadexPrimitivesWithdrawal>], { main: AccountId32, withdrawals: Vec<PolkadexPrimitivesWithdrawal> }>;
      /**
       * Withdrawal failed
       **/
      WithdrawalFailed: AugmentedEvent<ApiType, [PolkadexPrimitivesWithdrawal]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    pdexMigration: {
      NativePDEXMintedAndLocked: AugmentedEvent<ApiType, [AccountId32, AccountId32, u128]>;
      NotOperational: AugmentedEvent<ApiType, []>;
      RelayerStatusUpdated: AugmentedEvent<ApiType, [AccountId32, bool]>;
      RevertedMintedTokens: AugmentedEvent<ApiType, [AccountId32]>;
      TokenBurnDetected: AugmentedEvent<ApiType, [H256, AccountId32]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId32, who: AccountId32, proxyType: NodePolkadexRuntimeProxyType, disambiguationIndex: u16], { anonymous: AccountId32, who: AccountId32, proxyType: NodePolkadexRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: NodePolkadexRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: NodePolkadexRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: NodePolkadexRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: NodePolkadexRuntimeProxyType, delay: u32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
